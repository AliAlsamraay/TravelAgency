    ...
    <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden" id="example-collapse-sidebar">
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @endcan
                @can('bookings_management_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is("admin/bookings*")||request()->is("admin/tour-packages*")||request()->is("admin/tours*")||request()->is("admin/hotels*")||request()->is("admin/locations*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas c-sidebar-nav-icon fa-plane">
                            </i>
                            {{ trans('cruds.bookingsManagement.title') }}
                        </a>
                        <ul class="ml-4 subnav hidden">
                            @can('booking_access')
                                <li class="items-center">
                            ...
                            @endcan
                            @can('tour_package_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/tour-packages*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.tour-packages.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
                                        {{ trans('cruds.tourPackage.title') }}
                                    </a>
                                </li>
                            @endcan
                            @can('tour_access')
                            ...
                            @can('hotel_access')
                                <li class="items-center">
                                    <a class="{{ request()->is("admin/hotels*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.hotels.index") }}">
                                        <i class="fa-fw c-sidebar-nav-icon fas fa-cogs">
                                        </i>
